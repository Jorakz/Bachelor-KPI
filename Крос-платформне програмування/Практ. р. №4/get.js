...
// fields ids
let
  fields = [ _id_, 'nm', 'aut', 'the', 'per', 'quan' , 'tick', 'mus' ];
...
let
  ...
  if ( ok )
    ...
    case 'quan'   : let quantity_of_acts = parseInt(elem.value); ok = quantity_of_acts > 0; break;
    case 'tick' : let ticket_price = parseInt(elem.value); ok = ticket_price > 0; break;
    case 'mus' : let mus = parseInt(elem.value); ok = mus === 0 || mus === 1; break;
    }

...
<?php
  ...
  $ok
    ...
    $vals
      ...
      $stmt->bind_result
      (
        $vals[$fields[0][_fld_fld_]], $vals[$fields[1][_fld_fld_]], $vals[$fields[2][_fld_fld_]],$vals[$fields[3][_fld_fld_]],
        $vals[$fields[4][_fld_fld_]], $vals[$fields[5][_fld_fld_]], $vals[$fields[6][_fld_fld_]],$vals[$fields[7][_fld_fld_]]
      );
...
<hr>
Ваш IP-адрес : <?=$_SERVER['REMOTE_ADDR']?>,  текущие дата и время : <?=date('m/d/Y h:i:s a', time())?>,  страница сформирована за : <?=microtime()-$start?>  сек
<hr>
